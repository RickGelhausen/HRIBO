...
:cite:p:`xiao2016xtail`, deltaTE :cite:p:`chothani2019deltate`, and RiboRex
:cite:p:`li2017riborex` when that optional analysis is enabled.  RiboRex and
deltaTE also use the DESeq2 framework :cite:p:`love2014deseq2`.
