...
rule multiqc:
    input:
        ...
        expand("centeredtracks/{method}-{condition}-{replicate}.centered.forward.wig", zip, method=samples["method"], condition=samples["condition"], replicate=samples["replicate"])
