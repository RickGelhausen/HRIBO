...
rule rbsTrack:
    ...
    threads: 1
    shell:
        "mkdir -p tracks; SPtools/scripts/motif2GFF3.py --input_genome_fasta_filepath {input.fwd} --input_reverse_genome_fasta_filepath {input.rev} --motif_string AGGAG --output_gff3_filepath {output}"
