#!/usr/bin/env python
"""Summarise the Reparation ORF predictions as a spreadsheet.

The table layout is the only thing specific to this script; the genome lookup,
RPKM and translational efficiency arithmetic are shared with the DeepRibo and
...
def main():
    parser = argparse.ArgumentParser(
        description="Create an excel file of the Reparation predictions with read counts and RPKM."
    )
